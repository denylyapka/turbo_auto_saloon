...
class CarInterior(EntityDB):
    ...
    steering_control_material = Column(String(50), nullable=False)
    steering_control_side = Column(String(50), nullable=False)
    steering_control_type_of_amplifier = Column(String(50), nullable=False)
    climate = Column(String, nullable=True)
    wheel_diameter = Column(SmallInteger, nullable=False)
    anti_theft = Column(String, nullable=True)
    help_driving = Column(String, nullable=True)
    salon_material = Column(String(200), nullable=False)
    salon_hatch = Column(Boolean, nullable=False)
    salon_color = Column(String(200), nullable=False)
    heated = Column(String, nullable=True)
    electric = Column(String, nullable=True)
    head_lights_type = Column(String(50), nullable=False)
    head_lights_washers = Column(Boolean, nullable=False)
    multumedia = Column(String, nullable=True)
    quantity_speaker = Column(SmallInteger, nullable=False)
    subwoofer = Column(Boolean, nullable=False)
