...
class DetailEntity(EntityDB):
    ...
    brand_id = Column(Integer, ForeignKey('detail_brands.id', ondelete="CASCADE"), nullable=True)
    category_id = Column(Integer, ForeignKey('detail_categories.id', ondelete="CASCADE"), nullable=True)
